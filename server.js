...
const Admins = new Set([
  ...
  "yashashwi.2022ca113@mnnit.ac.in",
]);
var id;
var call = 0;
var quizScore = 0;
...
passport.use(
  new GoogleStrategy(
    {
      clientID:
        "312196478227-segok9fv6b9r117g18nd41jhlrpivhk7.apps.googleusercontent.com",
...
app.post("/signup", (req, res) => {
  ...
  User.register(
    { FirstName: FirstName, email: email, LastName: LastName, age: age },
    req.body.password,
    function (err, user) {
      if (err) {
...
app.use(
  ...
  express.static("directory_containing_js_files", {
    setHeaders: (res, path) => {
      if (path.endsWith(".js")) {
